...
function ChickenParallax () {
    ...
    <header>
        ...
        <div id="parallaxContainer">
            ...
            <img src={chicken} alt="" className="parallaxLayer" style={{transform: `translateY(${offsetY * 0.3}px)`}}/>
            <img src={leafL} alt="" className="parallaxLayer" />
            <img src={leafR} alt="" className="parallaxLayer" />
        </div>
    </header>
    )
}
